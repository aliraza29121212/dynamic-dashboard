...
document.addEventListener('DOMContentLoaded', function() {
  // Find the element with the class "MuiDialogTitle-root"
  var dialogTitle = document.querySelector('.card-title');

  // Check if the element is found
  if (dialogTitle) {
    // Create a text node with the desired text
    var textNode = document.createTextNode('Add Content and Details');
